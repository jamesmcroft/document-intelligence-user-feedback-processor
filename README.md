# Azure AI Document Intelligence Custom Model User Feedback Loop Sample

> [!IMPORTANT]
> This sample will no longer receive updates and has been archived for reference only.
